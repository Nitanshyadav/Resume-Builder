...
const addExperience = () => {
  ...
  const generateDescription=async (index)=>{
    ...
    const prompt=`enhance this job description: "${experience.description || 'No description provided'}" for the position of "${experience.position || 'Unknown position'}" at "${experience.company || 'Unknown company'}".`
  ...
  return (
    <div className='space-y-6'>
        ...
        <div>
          <h3 className='flex items-centter gap-2 text-lg font-semibold text-gray-900'>Professional Experience</h3>
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              ...
              <div className='space-y-2'>
                <div className='flex items-center justify-between'>
                  ...
                  disabled={generatingIndex===index} className='flex items-center gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
