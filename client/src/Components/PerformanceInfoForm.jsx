...
const PerformanceInfoForm = ({data={},onChange,removeBackground,setRemoveBackground}) => {
  ...
  return (
    <div>
      <h3 className='text-lg font-semibold text-fray-900'>Personal Information</h3>
...
export default PerformanceInfoForm;