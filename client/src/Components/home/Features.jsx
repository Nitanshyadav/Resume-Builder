    ...
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
      ...
      <div className="flex justify-center">
       <div className="inline-flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-indigo-200 rounded-full px-6 py-1.5">
        ...
        <Title title='build your resume' description='ourstreamlined process helps you create a professional resume in minutes with intelligient AI-powered tools and features'/>
