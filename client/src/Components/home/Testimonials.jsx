  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
      <div className="flex justify-center">
       <div className="inline-flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-indigo-200 rounded-full px-6 py-1.5">
            <BookUserIcon className="size-4.5 stroke-green-600"/>
            <span>Testimonials</span>
        </div>
      </div>
        <Title title="Don't Just take our words" description="Hear what our users say about us.Were always looking for ways to improve.If you have any feedback, we would love to hear from you!"/>
    </div>
