  ...
  return (
    <div className='space-y-4'>
        <div>
          ...
          <p className='text-sm text-gray-500'>Add your skills
          </p>
        </div>

        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a skill and press Enter'className='flex-1 px-3 py-2 text-sm' value={newskill} onChange={(e)=>setNewSkill(e.target.value)} onKeyDown={handleKeyPress} />
            <button onClick={addSkill} disabled={!newskill.trim} className='flex-items-center gap-2 px-4 py-2 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'>
